...
export default function BackupManagement() {
  ...
  const loadBackups = async () => {
    try {
      setLoading(true)
      const response = await fetch('https://netaqcrm.site/api/backups/list', {
        headers: {
  ...
  const loadStorageInfo = async () => {
    try {
      const response = await fetch('https://netaqcrm.site/api/backups/storage', {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('authToken') || 'dev-token'}`
        }
      })
  ...
  const createBackup = async () => {
    try {
      ...
      const response = await fetch('https://netaqcrm.site/api/backups/create', {
        method: 'POST',
        headers: {
  ...
  const downloadBackup = async (backupId, filename) => {
    try {
      ...
      const response = await fetch(`https://netaqcrm.site/api/backups/download/${backupId}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('authToken') || 'dev-token'}`
        }
      })
  ...
  const restoreBackup = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://netaqcrm.site/api/backups/restore/${backupId}`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('authToken') || 'dev-token'}`
        }
  ...
  const deleteBackup = async () => {
    ...
    try {
      const response = await fetch(`https://netaqcrm.site/api/backups/delete/${backupId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('authToken') || 'dev-token'}`
        }
  ...
  const uploadBackup = async (file) => {
    try {
      ...
      const response = await fetch('https://netaqcrm.site/api/backups/upload', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('authToken') || 'dev-token'}`
        },
  ...
  const clearAllBackups = async () => {
    ...
    try {
      ...
      const response = await fetch('https://netaqcrm.site/api/backups/clear-all', {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('authToken') || 'dev-token'}`
        }
